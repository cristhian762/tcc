...
from sklearn.utils.validation import sys


def create_dir_with_resumes_by_label(
    origin, destination, extenssion, multilabel=True, limit=0
):
    ...
    for file in files_name:
        ...
        if limit and limit <= qtd_resumes:
            return
